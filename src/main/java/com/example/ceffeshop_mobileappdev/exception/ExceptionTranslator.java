//package com.example.ceffeshop_mobileappdev.exception;
//
...
//
//    @Value("${jhipster.clientApp.name:unipassApi}")
...
//        return Strings.CS.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.example.ceffeshop_mobileappdev");
//    }
//}